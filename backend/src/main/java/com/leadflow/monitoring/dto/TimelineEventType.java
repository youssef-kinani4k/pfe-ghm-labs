...
/**
 * Les neuf faits qu'un lead peut avoir vecus. L'ordre de declaration est l'ordre du
...
public enum TimelineEventType {
    ...
    REATTRIBUTION,
    SYNC_ERP,
    // Apres SYNC_ERP : on ne previent le commercial qu'une fois le lead arrive chez lui
    // dans l'ERP. Prevenir plus tot l'enverrait chercher une fiche qui n'existe pas encore.
    NOTIFICATION,
    MORT,
