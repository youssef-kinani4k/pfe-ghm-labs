...
class QualifiedLeadRelayTest {
    ...
    void republieUnLeadQualifieAssezVieux() {
        UUID leadId = creeUnLeadQualifieVieuxDe(Duration.ofMinutes(10));
    ...
    void ignoreUnLeadTropRecent() {
        creeUnLeadQualifieVieuxDe(Duration.ofSeconds(5));
    ...
    private UUID creeUnLeadQualifieVieuxDe(Duration age) {
